{ lib, withSystem, ... }:
# TODO: add compositor specific catches (needed for hyprland/Niri IPC). Could be solved with seperate files having
# hyprland/niri modules: flake.modules.homeManager.niri/hyprland that only applies on hosts with this desktop.
let
  mode = "privacy";
in
{
